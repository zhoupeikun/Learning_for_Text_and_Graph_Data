...
train = pd.read_csv(c_wd+ "\\data\\webkb-train-stemmed.txt", header=None, delimiter="\t")
print train.shape

test = pd.read_csv(c_wd+ "\\data\\webkb-test-stemmed.txt", header=None, delimiter="\t")
print test.shape
...
print "accuracy TF-IDF:", metrics.accuracy_score(truth_array,predictions_tfidf)

print "accuracy TW-IDF degree:", metrics.accuracy_score(truth_array,predictions_degree)

print "accuracy TW-IDF weighted degree:", metrics.accuracy_score(truth_array,predictions_w_degree)

print "accuracy TW-IDF closeness:", metrics.accuracy_score(truth_array,predictions_closeness)

print "accuracy TW-IDF weighted closeness:", metrics.accuracy_score(truth_array,predictions_w_closeness)

# show the most and less important features for each class

print_top10(all_unique_terms, classifier_tfidf, unique_labels)

print_bot10(all_unique_terms, classifier_tfidf, unique_labels)