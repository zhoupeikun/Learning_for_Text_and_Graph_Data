...
"""
This module implements the Louvain method.
"""
from __future__ import print_function
__all__ = ["partition_at_level", "modularity", "louvain", "generate_dendrogram", "generate_dendogram", "induced_graph"]
...
def partition_at_level(dendrogram, level) :
    ...
    See Also
    --------
    louvain which directly combines partition_at_level and generate_dendrogram to obtain the partition of highest modularity
...
def louvain(graph, partition = None) :
